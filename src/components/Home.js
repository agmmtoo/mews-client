...
const MewsListItem = ({ mews, mewslist, setMewslist }) => {
    let ms = new Date(mews.createdAt) / 1000
    return (
        <Fade>
            <div className='border dark:border-slate-500 rounded-lg shadow-md bg-slate-50 dark:bg-neutral-700 mx-auto mt-5 p-3 w-11/12 md:w-4/5 '>
