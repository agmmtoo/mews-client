...
const MewsDetail = ({ mews }) => {
    ...
    return (
        <div className='rounded-lg shadow-md mx-auto mt-5 p-3 w-11/12 md:w-4/5 bg-gradient-to-r from-fuchsia-300 to-indigo-300 dark:from-violet-400 dark:to-fuchsia-400'>
